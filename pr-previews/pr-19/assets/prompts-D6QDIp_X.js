...
Reply with JSON: {"estimate": "3d", "why": "..."}`}]},parse(e){const n=T(e),t=b(typeof n=="string"?n:(n==null?void 0:n.estimate)??(n==null?void 0:n.duration)),s=/(\d+(?:\.\d+)?)\s*([hdw])/i.exec(t);if(!s){const o=new Error(`Model returned an unusable estimate: "${t||"(empty)"}"`);throw o.raw=JSON.stringify(n),o}const i=`${Number(s[1])}${s[2].toLowerCase()}`;return[{kind:"estimate",label:i,detail:b((n==null?void 0:n.why)??(n==null?void 0:n.rationale)),estimate:i}]}},rn={subtasks:ke,missing:_e,estimate:Se};export{z as $,le as A,Je as B,Ge as C,N as D,rn as E,sn as F,$ as G,re as H,Xe as I,en as J,ae as K,ie as L,on as M,Qe as N,qe as O,Ze as P,Ve as Q,Ke as R,S,x as T,Q as U,Z as V,V as W,X,q as Y,J as Z,We as _,Ye as a,K as a0,I as a1,de as a2,ne as a3,te as a4,ee as a5,T as a6,ge as a7,je as b,Ue as c,Ie as d,Fe as e,Re as f,Ne as g,Le as h,Be as i,Ee as j,De as k,Me as l,Ce as m,Ae as n,Te as o,Oe as p,$e as q,ve as r,xe as s,ze as t,tn as u,Pe as v,He as w,m as x,ce as y,nn as z};
