...
- [ ] Pricing page
- [ ] Docs shell
`,M=["id","title","goal","project","people","due","estimate","created","done","blocked-by","part-of"],B=new Set(["project","people","blocked-by","part-of"]),j=/^\s*[-*]\s+\[([ xX])\]\s?(.*)$/;function L(e){const n=e.trim();return n.length>=2&&(n[0]==='"'||n[0]==="'")&&n[n.length-1]===n[0]?n.slice(1,-1):n}function D(e){const n=e.trim();return n===""?"":n==="true"?!0:n==="false"?!1:n==="null"||n==="~"?null:L(n)}function Y(e){const n=e.trim().slice(1,-1).trim();if(n==="")return[];const t=[];let s="",i=null;for(const o of n)i?(o===i&&(i=null),s+=o):o==='"'||o==="'"?(i=o,s+=o):o===","?(t.push(s),s=""):s+=o;return t.push(s),t.map(o=>L(o)).filter(o=>o!=="")}function S(e){const n=String(e).replace(/\r\n/g,`
`);if(!n.startsWith(`---
`))return{data:{},body:n.replace(/^\n+/,"")};const t=n.indexOf(`
---`,3);if(t===-1)return{data:{},body:n};const s=n.slice(4,t+1),i=n.indexOf(`
`,t+1),o=i===-1?"":n.slice(i+1),r={},a=s.split(`
`);let c=null;for(const l of a){if(l.trim()===""||l.trimStart().startsWith("#"))continue;const u=/^\s*-\s+(.*)$/.exec(l);if(u&&c){r[c].push(D(u[1]));continue}const g=/^([A-Za-z0-9_][A-Za-z0-9_-]*)\s*:\s*(.*)$/.exec(l);if(!g)continue;const[,p,h]=g;c=null,h.trim()===""?(r[p]=[],c=p):h.trim().startsWith("[")&&h.trim().endsWith("]")?r[p]=Y(h):r[p]=D(h)}for(const[l,u]of Object.entries(r))Array.isArray(u)&&u.length===0&&!B.has(l)&&(r[l]="");return{data:r,body:o}}function W(e){const n=String(e);return n===""||/^[#&*!|>%@`?-]/.test(n)||/[:,[\]{}]/.test(n)||n!==n.trim()||["true","false","null","~"].includes(n)}function E(e){return typeof e=="boolean"||typeof e=="number"?String(e):e==null?"":W(e)?`'${String(e).replace(/'/g,"''")}'`:String(e)}function G(e,n){return Array.isArray(n)||B.has(e)?`[${(Array.isArray(n)?n:[n].filter(s=>s!==""&&s!=null)).map(E).join(", ")}]`:E(n)}function x(e,n=""){const s=[...M.filter(o=>o in e),...Object.keys(e).filter(o=>!M.includes(o))].map(o=>`${o}: ${G(o,e[o])}`),i=String(n).replace(/\s+$/,"");return`---
${s.join(`
`)}
---
${i?`${i}
...
${t}`:s:t}const v="_project-",w=864e5,P={æ:"ae",ø:"o",å:"a",ß:"ss",ð:"d",þ:"th",ł:"l",đ:"d"};function z(e){return String(e).toLowerCase().replace(/[æøåßðþłđ]/g,t=>P[t]).normalize("NFKD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,60)||"task"}function Ge(e,n){const t=z(e),s=n instanceof Set?n:new Set(n);if(!s.has(t))return t;for(let i=2;;i+=1){const o=`${t}-${i}`;if(!s.has(o))return o}}function m(e){if(e==null||e==="")return null;const n=/^(\d{4})-(\d{2})-(\d{2})/.exec(String(e).trim());if(!n)return null;const t=Date.UTC(Number(n[1]),Number(n[2])-1,Number(n[3]));return Number.isNaN(t)?null:t}function N(e){return e==null?"":new Date(e).toISOString().slice(0,10)}const H={h:1,d:8,w:40};function K(e){if(e==null||e==="")return null;const n=String(e).trim().toLowerCase(),t=/^(\d+(?:\.\d+)?)\s*([hdw])$/.exec(n);return t?Number(t[1])*H[t[2]]:null}function qe(e){return e.reduce((n,t)=>n+(K(t.estimate)??0),0)}function _(e){return e==null||e===""?[]:(Array.isArray(e)?e:[e]).map(n=>String(n).trim()).filter(Boolean)}function Q(e,n){const{data:t,body:s}=S(n),{notes:i,subtasks:o}=q(s),r=String(e).replace(/\.md$/i,"");return{id:String(t.id||r),title:String(t.title||r),project:_(t.project),people:_(t.people),due:t.due?String(t.due):"",estimate:t.estimate?String(t.estimate):"",created:t.created?String(t.created):"",done:t.done===!0,goal:t.goal===!0,blockedBy:_(t["blocked-by"]),partOf:_(t["part-of"]),notes:i,subtasks:o,extra:Object.fromEntries(Object.entries(t).filter(([a])=>!["id","title","project","people","due","estimate","created","done","goal","blocked-by","part-of"].includes(a)))}}function R(e,n=[]){return Object.fromEntries(Object.entries(e).filter(([t,s])=>n.includes(t)?!0:Array.isArray(s)?s.length>0:s!==""&&s!=null))}function Z(e){const n=R({id:e.id,title:e.title,project:e.project??[],people:e.people??[],due:e.due??"",estimate:e.estimate??"",created:e.created??"",done:!!e.done,...e.goal?{goal:!0}:{},"blocked-by":e.blockedBy??[],"part-of":e.partOf??[],...e.extra??{}},["id","title","done"]);return x(n,J(e.notes,e.subtasks))}function V(e,n){const{data:t,body:s}=S(n),i=String(e).replace(/\.md$/i,"").replace(new RegExp(`^${v}`),"");return{id:String(t.id||i),title:String(t.title||i),goal:t.goal?String(t.goal):"",people:_(t.people),start:t.start?String(t.start):"",end:t.end?String(t.end):"",color:t.color?String(t.color):"",context:String(s).trim()}}function X(e){return x(R({id:e.id,title:e.title,goal:e.goal??"",people:e.people??[],start:e.start??"",end:e.end??"",color:e.color??""},["id","title"]),e.context??"")}const F="_trash.md",ee=50;function ne(e){const{body:n}=S(e),t=/```json\s*\n([\s\S]*?)```/.exec(String(n));if(!t)return[];try{const s=JSON.parse(t[1]);return Array.isArray(s)?s:[]}catch{return[]}}function te(e){const n=["```json",JSON.stringify(e??[],null,2),"```"].join(`
`);return x({id:"_trash"},n)}function Je(e,n){return[n,...e??[]].slice(0,ee)}const oe=e=>`${e.id}.md`,se=e=>`${v}${e.id}.md`;function Pe(e){const n=[],t=[];let s=[];for(const[i,o]of Object.entries(e)){if(!/\.md$/i.test(i))continue;const r=i.split("/").pop();r===F?s=ne(o):r.startsWith(v)?t.push(V(r,o)):n.push(Q(r,o))}return n.sort((i,o)=>i.id.localeCompare(o.id)),t.sort((i,o)=>i.id.localeCompare(o.id)),{tasks:n,projects:t,trash:s}}function ze({tasks:e,projects:n,trash:t}){const s={};for(const i of n)s[se(i)]=X(i);for(const i of e)s[oe(i)]=Z(i);return t!=null&&t.length&&(s[F]=te(t)),s}const re=e=>`${e}-goal`;function He({tasks:e,projects:n},t=Date.now()){const s=new Map(n.filter(r=>{var a;return(a=r.goal)==null?void 0:a.trim()}).map(r=>[re(r.id),r])),i=[];let o=[];for(const r of e){if(!r.goal){o.push(r);continue}const a=s.get(r.id);if(!a){i.push(r);continue}s.delete(r.id);const c=a.goal.trim(),l=a.end??"";o.push(r.title===c&&r.due===l?r:{...r,title:c,due:l})}for(const[r,a]of s)o.push({id:r,title:a.goal.trim(),project:[a.id],people:[],due:a.end??"",estimate:"",created:N(t),done:!1,goal:!0,blockedBy:[],partOf:[],notes:"",subtasks:[],extra:{}});return o.sort((r,a)=>r.id.localeCompare(a.id)),{tasks:o,removed:i}}function Ke(e,n,t){const s=e.find(c=>c.id===n),i=e.find(c=>c.id===t);if(!s||!i||n===t||s.goal||i.goal)return null;const o=[{done:!!s.done,text:s.title},...s.subtasks??[]],r=(c,l)=>[...new Set((c??[]).map(u=>u===n?t:u))].filter(u=>u!==l);return{tasks:e.filter(c=>c.id!==n).map(c=>{const l=c.id===t?{...c,subtasks:[...c.subtasks??[],...o]}:c;return{...l,blockedBy:r(l.blockedBy,l.id),partOf:r(l.partOf,l.id)}}),merged:s}}const y={day:{unit:"day",label:"Days",level(e,n){return(e-n)/w},dateForLevel(e,n){return n+e*w},format(e){return new Date(e).toISOString().slice(5,10).replace("-","/")}},week:{unit:"week",label:"Weeks",level(e,n){return(e-n)/(7*w)},dateForLevel(e,n){return n+e*7*w},format(e){return`${new Date(e).toISOString().slice(5,10).replace("-","/")}`}},month:{unit:"month",label:"Months",level(e,n){const t=new Date(n),s=new Date(e),i=(s.getUTCFullYear()-t.getUTCFullYear())*12+(s.getUTCMonth()-t.getUTCMonth()),o=Date.UTC(s.getUTCFullYear(),s.getUTCMonth(),1),r=Date.UTC(s.getUTCFullYear(),s.getUTCMonth()+1,1);return i+(e-o)/(r-o)},dateForLevel(e,n){const t=new Date(n);return Date.UTC(t.getUTCFullYear(),t.getUTCMonth()+Math.round(e),1)},format(e){const n=new Date(e);return`${n.toLocaleString("en",{month:"short",timeZone:"UTC"})} ${n.getUTCFullYear()}`}}};function Qe(e,n){if(e==null||n==null||n<=e)return y.week;const t=(n-e)/w;return t<=31?y.day:t<=240?y.week:y.month}function Ze(e){return y[e]??y.week}function Ve(e,n){const t=n.map(l=>m(l.due)).filter(l=>l!=null),s=m(e==null?void 0:e.start),i=m(e==null?void 0:e.end),o=[s,...t].filter(l=>l!=null),r=[i,...t].filter(l=>l!=null),a=o.length?Math.min(...o):Date.now(),c=r.length?Math.max(...r):a+30*w;return{start:a,end:Math.max(c,a)}}function Xe(e,{bucket:n,start:t,collapse:s=!1}){const i=new Map;for(const d of e){const f=m(d.due);f!=null&&i.set(d.id,Math.floor(n.level(f,t)))}const o=[...i.values()],r=o.length?Math.min(...o):0,a=o.length?Math.max(...o):0,c=[...new Set(o)].sort((d,f)=>d-f),l=s?new Map(c.map((d,f)=>[d,f])):new Map(c.map(d=>[d,d-r])),u=s?Math.max(0,c.length-1):a-r,g=u+2,p=new Map;for(const d of e)p.set(d.id,i.has(d.id)?l.get(i.get(d.id)):g);const h=s?new Map([...l].map(([d,f])=>[f,d-r])):new Map(Array.from({length:u+1},(d,f)=>[f,f])),A=[];return s&&c.forEach((d,f)=>{const C=c[f-1];f>0&&d-C>1&&A.push({afterLevel:f-1,periods:d-C-1})}),{levels:p,trayLevel:g,minLevel:r,lastLevel:u,levelOrigin:h,gaps:A}}function ie(e,n,t=Date.now()){var a,c;const s=((a=e.subtasks)==null?void 0:a.length)??0,i=((c=e.subtasks)==null?void 0:c.filter(l=>l.done).length)??0,o=m(e.due),r=(e.blockedBy??[]).filter(l=>n.has(l)&&!n.get(l).done);return{done:!!e.done,total:s,checked:i,ratio:e.done?1:s===0?0:i/s,started:!e.done&&i>0,blocked:!e.done&&r.length>0,blockers:r,overdue:!e.done&&o!=null&&o<t}}const ae=e=>new Map(e.map(n=>[n.id,n]));function le(e){return[...new Set(e.flatMap(n=>n.people??[]))].sort((n,t)=>n.localeCompare(t))}function en(e){return[...new Set(e.flatMap(n=>n.project??[]))].sort((n,t)=>n.localeCompare(t))}function nn(e,n){const t=ce(n,{projectId:(e==null?void 0:e.id)??null}),s=(e==null?void 0:e.people)??[],i=[...new Set([...s,...le(t)])],o=new Set(s);return i.map(r=>({name:r,inRoster:o.has(r),openTasks:t.filter(a=>!a.done&&(a.people??[]).includes(r)).length})).sort((r,a)=>Number(a.inRoster)-Number(r.inRoster)||r.name.localeCompare(a.name))}function ce(e,{projectId:n=null,people:t=[],hideDone:s=!1}={}){const i=new Set(t);return e.filter(o=>!(n&&!(o.project??[]).includes(n)||i.size>0&&!(o.people??[]).some(r=>i.has(r))||s&&o.done))}function de(e){const n=new Set(e.map(o=>o.id)),t=new Map;for(const o of e)if(o.goal)for(const r of o.project??[])t.set(r,o.id);if(!t.size)return[];const s=new Set;for(const o of e){for(const r of o.blockedBy??[])n.has(r)&&s.add(r);for(const r of o.partOf??[])n.has(r)&&s.add(o.id)}const i=[];for(const o of e){if(o.goal||s.has(o.id))continue;const r=(o.project??[]).map(a=>t.get(a)).find(Boolean);r&&r!==o.id&&i.push({from:o.id,to:r})}return i}function tn(e,n){const t=new Set(e.map(r=>r.id)),s=new Set(e.filter(r=>r.due).map(r=>r.id)),i=(r,a)=>s.has(r)&&s.has(a)&&((n==null?void 0:n.get(r))??0)>((n==null?void 0:n.get(a))??0),o=[];for(const{from:r,to:a}of de(e))o.push({id:`goal:${r}->${a}`,from:r,to:a,kind:"goal",conflict:i(r,a)});for(const r of e){for(const a of r.blockedBy??[]){if(!t.has(a))continue;const c=i(a,r.id);o.push({id:`blocks:${a}->${r.id}`,from:a,to:r.id,kind:"blocks",conflict:c})}for(const a of r.partOf??[])t.has(a)&&o.push({id:`part-of:${r.id}->${a}`,from:r.id,to:a,kind:"part-of",conflict:!1})}return o}const ue=67324752,fe=33639248,pe=101010256,he=(()=>{const e=new Uint32Array(256);for(let n=0;n<256;n+=1){let t=n;for(let s=0;s<8;s+=1)t=t&1?3988292384^t>>>1:t>>>1;e[n]=t>>>0}return e})();function ge(e){let n=4294967295;for(let t=0;t<e.length;t+=1)n=he[(n^e[t])&255]^n>>>8;return(n^4294967295)>>>0}function be(e){const n=Math.max(1980,e.getFullYear());return{time:e.getHours()<<11|e.getMinutes()<<5|Math.floor(e.getSeconds()/2),date:n-1980<<9|e.getMonth()+1<<5|e.getDate()}}class me{constructor(){this.chunks=[],this.length=0}bytes(n){this.chunks.push(n),this.length+=n.length}u16(n){this.bytes(new Uint8Array([n&255,n>>>8&255]))}u32(n){this.bytes(new Uint8Array([n&255,n>>>8&255,n>>>16&255,n>>>24&255]))}concat(){const n=new Uint8Array(this.length);let t=0;for(const s of this.chunks)n.set(s,t),t+=s.length;return n}}function on(e,n=new Date){const t=new TextEncoder,{time:s,date:i}=be(n),o=new me,r=[];for(const[l,u]of Object.entries(e)){const g=t.encode(l),p=t.encode(u),h=ge(p);r.push({nameBytes:g,size:p.length,crc:h,offset:o.length}),o.u32(ue),o.u16(20),o.u16(2048),o.u16(0),o.u16(s),o.u16(i),o.u32(h),o.u32(p.length),o.u32(p.length),o.u16(g.length),o.u16(0),o.bytes(g),o.bytes(p)}const a=o.length;for(const l of r)o.u32(fe),o.u16(20),o.u16(20),o.u16(2048),o.u16(0),o.u16(s),o.u16(i),o.u32(l.crc),o.u32(l.size),o.u32(l.size),o.u16(l.nameBytes.length),o.u16(0),o.u16(0),o.u16(0),o.u16(0),o.u32(0),o.u32(l.offset),o.bytes(l.nameBytes);const c=o.length-a;return o.u32(pe),o.u16(0),o.u16(0),o.u16(r.length),o.u16(r.length),o.u32(c),o.u32(a),o.u16(0),o.concat()}const k=e=>String(e??"").replace(/\|/g,"\\|").replace(/\n+/g," ").trim(),we=e=>(e.people??[]).join(", ");function ye(e){return e.done?"done":e.total===0?"—":`${e.checked}/${e.total}`}function $(e,n,{now:t=Date.now()}={}){const s=ae(n),i=[];i.push(`# ${(e==null?void 0:e.title)||"Untitled project"}`),e!=null&&e.goal&&i.push("","## Goal",e.goal.trim()),e!=null&&e.context&&i.push("","## Context",e.context.trim());const o=[e==null?void 0:e.start,e==null?void 0:e.end].filter(Boolean);i.push(""),o.length===2&&i.push(`Window: ${e.start} → ${e.end}`),i.push(`Today: ${N(t)}`),i.push("","## Tasks","","| id | task | due | estimate | people | subtasks |"),i.push("|----|------|-----|----------|--------|----------|");const r=[...n].sort((c,l)=>(m(c.due)??1/0)-(m(l.due)??1/0));for(const c of r){const l=ie(c,s,t);i.push(`| ${k(c.id)} | ${k(c.title)} | ${k(c.due)||"—"} | ${k(c.estimate)||"—"} | ${k(we(c))||"—"} | ${ye(l)} |`)}r.length===0&&i.push("| — | _no tasks yet_ | — | — | — | — |");const a=[];for(const c of r){for(const l of c.blockedBy??[])s.has(l)&&a.push(`- ${c.id} blocked-by ${l}`);for(const l of c.partOf??[])s.has(l)&&a.push(`- ${c.id} part-of ${l}`)}return i.push("","## Dependencies",""),i.push(a.length?a.join(`
...
Reply with JSON: {"estimate": "3d", "why": "..."}`}]},parse(e){const n=T(e),t=b(typeof n=="string"?n:(n==null?void 0:n.estimate)??(n==null?void 0:n.duration)),s=/(\d+(?:\.\d+)?)\s*([hdw])/i.exec(t);if(!s){const o=new Error(`Model returned an unusable estimate: "${t||"(empty)"}"`);throw o.raw=JSON.stringify(n),o}const i=`${Number(s[1])}${s[2].toLowerCase()}`;return[{kind:"estimate",label:i,detail:b((n==null?void 0:n.why)??(n==null?void 0:n.rationale)),estimate:i}]}},sn={subtasks:ke,missing:_e,estimate:Se};export{K as $,Je as A,Ge as B,N as C,sn as D,on as E,$ as F,re as G,Ve as H,Xe as I,ae as J,ie as K,tn as L,nn as M,qe as N,Qe as O,Ze as P,Ke as Q,S as R,x as S,Q as T,Z as U,V,X as W,q as X,J as Y,z as Z,We as _,Ye as a,I as a0,de as a1,ne as a2,te as a3,ee as a4,T as a5,ge as a6,je as b,Ue as c,Ie as d,Fe as e,Re as f,Ne as g,Le as h,Be as i,Ee as j,De as k,Me as l,Ce as m,Ae as n,Te as o,Oe as p,$e as q,ve as r,xe as s,ze as t,Pe as u,He as v,m as w,en as x,le as y,ce as z};
